...
Los dos últimos (comparación de precios por proveedor y clientes con más ventas) se agregaron durante la fase, a partir de necesidades reales planteadas al usar los primeros reportes — no estaban en el alcance original de este documento.
