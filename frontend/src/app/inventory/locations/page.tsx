...
type LoadState =
  ...
  | {
      status: "success";
      data: PaginatedResponse<StorageLocation>;
      message: null;
    }
  | {
...
const INITIAL_FILTERS: StorageLocationFilters = {
  query: "",
  activeState: "active",
  page: 1,
  pageSize: 50,
...
function getLoadErrorMessage(
  ...
  return "No fue posible consultar las ubicaciones.";
}
...
export default function StorageLocationsPage() {
  ...
  const [filters, setFilters] =
    useState<StorageLocationFilters>(
      INITIAL_FILTERS,
    );
      ...
      .catch((error: unknown) => {
        ...
        if (
          ...
          setLoadState({
            ...
            data: null,
            message:
              "Este usuario no tiene permisos para consultar las ubicaciones.",
          });
  ...
  function updateFilters(
    updater: (
      current: StorageLocationFilters,
    ) => StorageLocationFilters,
  ): void {
    setLoadState({
      status: "loading",
  ...
  return (
    ...
    >
      <section
        ...
        aria-labelledby="locations-list-title"
      >
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-muted-foreground">
                Busque por código operativo o descripción.
              </p>
            </div>
            ...
            >
              ...
              <select
                ...
                onChange={(event) => {
                  const activeState =
                    event.target.value as StorageLocationFilters["activeState"];
                ...
                aria-label="Filtrar ubicaciones por estado"
              >
                <option value="active">
                  Activas
                </option>
          ...
          loadState.data.results.length === 0 && (
            <div className="p-6">
              <StatePanel
                ...
                message={
                  filters.query
                    ? "Revise el código o intente con otra descripción."
                    : "Todavía no existen ubicaciones para el filtro seleccionado."
                }
                icon={<LocationIcon />}
                action={
                  filters.query ? (
